...
@section('title', 'Editar Permiso - Super Admin')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Modifica la información del permiso</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('superadmin.permissions.show', $permission) }}" class="btn btn-outline-primary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('superadmin.permissions.update', $permission) }}">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" 
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category }}" 
                                                    {{ old('category', $permission->category) === $category ? 'selected' : '' }}>
                                                {{ ucfirst($category) }}
                                            </option>
                                        @endforeach
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('superadmin.permissions.show', $permission) }}" class="btn btn-outline-secondary">
