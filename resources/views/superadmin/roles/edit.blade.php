...
@section('title', 'Editar Rol - Super Admin')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('superadmin.roles.show', $role) }}" class="btn btn-outline-info">
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-edit me-2"></i>Información del Rol
                    </h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('superadmin.roles.update', $role) }}">
                                    ...
                                    <div class="col-md-4 col-lg-3 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ in_array($permission->id, old('permissions', $role->rolePermissions->pluck('id')->toArray())) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('superadmin.roles.show', $role) }}" class="btn btn-outline-secondary">
